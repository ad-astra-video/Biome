...
const FrameTimelineOverlay = () => {
  ...
  const { temporalCompression, timelineRef } = useFrames()
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      const { currentIndex, slotDisplayAts } = timelineRef.current
  ...
  }, [enabled, isStreaming, temporalCompression, timelineRef])
